...
const FoodCard = ({ food }) => {
  ...
  return (
    <div
      ...
      data-aos="fade-up"
    >
      <div className="relative flex h-48 w-full justify-center lg:h-[280px] transition duration-300 ease-in-out transform hover:scale-105">
        <div className="absolute left-4 z-10 right-4 top-4 flex items-center justify-between">
          {/* love  */}
      ...
      <div
        className="mx-auto w-[85%]  text-gray-800 space-y-2 text-center font-semibold"
        data-aos="fade-up"
      >
        <h6 className="text-sm md:text-base lg:text-lg">{name}</h6>
        <div className="flex justify-between">
          <p className="text-md font-bold md:text-md">Category: {category}</p>
          <h3 className="text-sm md:text-base lg:text-lg">Price: ${price}</h3>
        </div>
        <p className="text-md font-bold md:text-md">
          Recipe: {recipe.slice(0, 50)}...
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 text-sm md:text-base">
        ...
        >
          ...
          <span className="bg-secondary rounded-md absolute right-0 top-0  h-full flex items-center justify-center px-1 group-hover:duration-300 group-hover:w-full w-10 duration-300">
            <TbListDetails />
          </span>
        </Link>
